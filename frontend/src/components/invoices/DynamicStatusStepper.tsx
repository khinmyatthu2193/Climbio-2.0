...
const labels: Record<InvoiceStatus, string> = {
  ...
  READY_FOR_PICKUP: 'Ready for pickup', PICKED_UP: 'Picked up', PAID: 'Paid', CANCELLED: 'Cancelled',
};
