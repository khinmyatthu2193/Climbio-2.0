...
export function ProfilePage() {
  ...
  return <main className="page-container"><div className="mx-auto max-w-4xl"><nav className="mb-4 flex items-center gap-2 text-sm text-slate-500" aria-label="Breadcrumb"><a className="font-medium hover:text-violet-600" href="/">Workspace</a><span aria-hidden="true">/</span><span className="font-semibold text-slate-800 dark:text-slate-200">Settings</span></nav><PageHeader eyebrow="Account" title="Profile & shop settings" description="Manage your business identity, preferences, and account security." actions={<Badge className="bg-violet-50 text-violet-700 dark:bg-violet-500/10 dark:text-violet-300">{user.role}</Badge>} />
